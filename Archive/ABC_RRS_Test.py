...
def ABC_analysis(df):
    ...
    grouped_df = (
            df.loc[:, ['CustomerID','Prod','Revenue']]
            .groupby(by=['CustomerID','Prod'])
            .sum()         
        )
...
print(ABC_groups)
ABC_groups.to_csv(r'C:\Users\NA26035\OneDrive - Trinseo\Desktop\Udacity\Github_projects\ABC-XYZ-data_OP.csv')